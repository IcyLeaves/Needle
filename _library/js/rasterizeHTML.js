...
!(function (a) {
  ...
  return (function b(a, c, d) {
  ...
  })(
    {
        ...
        function (b, c, d) {
          !(function (e, f) {
            ...
            var g = (function (a) {
                ...
                return (
                  (b.parseOptionalParameters = function (a) {
                    var c = { canvas: null, options: {} };
                    return (
                      null == a[0] || e(a[0])
                        ? ((c.canvas = a[0] || null),
                          (c.options = b.clone(a[1])))
                        : (c.options = b.clone(a[0])),
                      c
                    );
                  }),
                  b
              ...
              h = (function (a, b) {
                ...
                return (
                  (c.baseUrlRespectingXhr = function (b, c) {
                    var e = function () {
                      var e = new b();
                      return (
                        d(e, "open", function (b, d) {
                          var e = b.shift(),
                            f = b.shift(),
                            g = a.joinUrl(c, f);
                  ...
                  (c.finishNotifyingXhr = function (a) {
                    var c = 0,
                      ...
                      h = function () {
                        var a = c - e;
                        0 >= a && f && g.resolve({ totalCount: c });
                      },
                      i = function () {
                        var b = new a();
                        return (
                          d(b, "send", function (a, b) {
                    ...
                    return (
                      (i.waitForRequestsToFinish = function () {
              ...
              i = (function () {
                ...
                (a.addClassName = function (a, b) {
                  ...
                  (a.addClassNameRecursively = function (b, c) {
                    a.addClassName(b, c),
                      b.parentNode !== b.ownerDocument &&
                        a.addClassNameRecursively(b.parentNode, c);
                  });
                var c = function (a, c) {
                ...
                return (
                  (a.rewriteCssSelectorWith = function (a, b, c) {
                    h(a, [b], function () {
                      return c;
                    });
                  }),
                  ...
                  (a.findHtmlOnlyNodeNames = function (a) {
                    for (
                      var b,
                        c = a.createTreeWalker(a, NodeFilter.SHOW_ELEMENT),
                        d = {},
                        e = {};
                      c.nextNode();

                    )
                      (b = c.currentNode.tagName.toLowerCase()),
                        "http://www.w3.org/1999/xhtml" ===
                        c.currentNode.namespaceURI
                          ? (d[b] = !0)
                          : (e[b] = !0);
              ...
              j = (function (a) {
                ...
                var b = {},
                  ...
                  d = { active: !0, hover: !0, focus: !1, target: !1 };
                return (
                  (b.fakeUserAction = function (b, c, e) {
                    ...
                    f &&
                      (d[e]
                        ? a.addClassNameRecursively(f, h)
                        : a.addClassName(f, h),
                      a.rewriteCssSelectorWith(b, g, "." + h));
                  }),
              ...
              k = (function (a) {
                ...
                var b,
                  ...
                  d = function () {
                    var a =
                        '<svg id="svg" xmlns="http://www.w3.org/2000/svg" width="10" height="10"><style>@media (max-width: 1em) { svg { background: #00f; } }</style></svg>',
                      b =
                ...
                var h = function (a) {
                  ...
                  o = function (a) {
                    var b = [];
                    return (
                      a.inverse && b.push("not"),
                      b.push(a.type),
                      a.expressions.length > 0 &&
                        b.push("and " + a.expressions.map(n).join(" and ")),
                      b.join(" ")
                    );
                  };
                ...
                return (
                  (c.workAroundWebKitEmSizeIssue = function (a) {
              ...
              l = (function (a, b, c, d, e) {
                ...
                var f = {},
                  g = function (a, b, c, d) {
                    ...
                    return (
                      ...
                      (e.style.top = -1e4 - d + "px"),
                      (e.style.left = -1e4 - c + "px"),
                      a.getElementsByTagName("body")[0].appendChild(e),
                      e
                    );
                  };
                f.executeJavascript = function (a, d) {
                  var f = g(e.document, "iframe", d.width, d.height),
                    ...
                    l = function () {
                      ...
                      e.document.getElementsByTagName("body")[0].removeChild(f),
                        j.resolve({ document: a, errors: i });
                    },
                    m = function () {
                      var a = c.defer();
                      return (
                        k > 0 ? setTimeout(a.resolve, k) : a.resolve(),
                        a.promise
                      );
                    };
                  f.onload = function () {
                  ...
                  return (
                    ...
                    (f.contentWindow.XMLHttpRequest = p),
                    (f.contentWindow.onerror = function (a) {
                      i.push({ resourceType: "scriptExecution", msg: a });
                    }),
                    f.contentDocument.write("<!DOCTYPE html>"),
                ...
                var h = function (a, b, c) {
                    ...
                    return (
                      ...
                      (d.style.top = -1e4 - c + "px"),
                      (d.style.left = -1e4 - b + "px"),
                      (d.sandbox = "allow-same-origin"),
                      (d.scrolling = "no"),
                      d
                    );
                  },
                  ...
                  k = function (a, b, c, d, f) {
                    ...
                    return (
                      (o = j({ width: i, height: k }, c, d, f)),
                      (l = e.getComputedStyle(a.documentElement).fontSize),
                      {
                        left: h,
                        top: g,
                        width: o.width,
                ...
                f.calculateDocumentContentSize = function (a, b) {
                  var d,
                    f = a.documentElement.outerHTML,
                    g = c.defer(),
                    h = b.zoom || 1;
                  return (
                    (d = i(b.width, b.height, h)),
                    ...
                    d.contentDocument.write("<!DOCTYPE html>"),
                    d.contentDocument.write(f),
                ...
                var l = function (a, b) {
                  ...
                  if (h)
                    for (
                      c = "<div" + h[1] + "></div>",
                        i.documentElement.innerHTML = c,
                        f = i.querySelector("div"),
                        d = 0;
                      d < f.attributes.length;
                      d++
                    )
                      (g = f.attributes[d]),
                        a.documentElement.setAttribute(g.name, g.value);
                };
                ...
                var m = function (a) {
                  try {
                    ...
                    throw { message: "Invalid source", originalError: b };
                  }
                };
                ...
                var n = null,
                  o = function (a, b) {
                    return "none" === b || "repeated" === b
                      ? ((null === n || "repeated" !== b) && (n = Date.now()),
                        a + "?_=" + n)
                      : a;
                  },
                  p = function (b, d) {
              ...
              n = (function (a, b, c, d, e) {
                ...
                var f = {},
                  g = function (a, b) {
                    ...
                    return (
                      1 !== c &&
                        (d.style =
                          "transform:scale(" + c + "); transform-origin: 0 0;"),
                      d
                    );
                  },
                  h = function (a) {
                    var b, c, d, e;
                    (b = Math.round(a.viewportWidth)),
                      (c = Math.round(a.viewportHeight)),
                      (d = -a.left),
                      (e = -a.top);
                    var f = { x: d, y: e, width: b, height: c };
                    return f;
                  },
                  i = function (a) {
                    var b = a.style || "";
                ...
                return (
                  (f.getSvgForDocument = function (a, b, e) {
                    return (
                      c.rewriteTagNameSelectorsToLowerCase(a),
                      d.needsEmWorkaround().then(function (c) {
                        return (
                          c && d.workAroundWebKitEmSizeIssue(a), m(a, b, e)
                        );
                      })
                    );
                  }),
              ...
              o = (function (a, b, c, d, e, f) {
                ...
                var g = {},
                  ...
                  i = function (a) {
                    return e.renderSvg(a).then(
                      function (b) {
                        return { image: b, svg: a };
                      },
                      function (a) {
                        throw h(a);
                      }
                  ...
                  l = function (a, d) {
                    return b.executeJavascript(a, d).then(function (a) {
                      var b = a.document;
                      return (
                        c.persistInputValues(b),
                        { document: b, errors: a.errors }
                      );
                    });
                  };
                return (
                  (g.rasterize = function (b, c, d) {
                    var e;
                    return (
                      (e = a.clone(d)),
                      (e.inlineScripts = d.executeJs === !0),
                      f
                        .inlineReferences(b, e)
                        .then(function (a) {
                          return d.executeJs
                            ? l(b, d).then(function (b) {
                                return {
                                  document: b.document,
              ...
              p = (function (a, b, c) {
                ...
                var h = function (b, c, d) {
                    ...
                    var f = d ? a.clone(d) : {};
                    return (
                      d.baseUrl || (f.baseUrl = c), { document: e, options: f }
                    );
                  },
                  i = function (a, c, e) {
        ...
        function (b, c, d) {
          !(function (b, e) {
            ...
            var a = {},
              ...
              c = function (a) {
                var b = a && a.then;
                return "object" == typeof a && "function" == typeof b
                  ? function () {
        ...
        function (a, b, c) {
          ...
          function e(a) {
            return a.split(",").map(function (a) {
              ...
              var b = a.match(i),
                ...
                f = {};
              return (
                (f.inverse = !!c && "not" === c.toLowerCase()),
                (f.type = d ? d.toLowerCase() : "all"),
                (e = e.match(/\([^\)]+\)/g) || []),
                (f.expressions = e.map(function (a) {
                  var b = a.match(j),
                    c = b[1].toLowerCase().match(k);
                  return { modifier: c[1], feature: c[2], value: b[2] };
                })),
                f
              );
            });
          ...
          function f(a) {
            var b,
              c = Number(a);
            return (
              c || ((b = a.match(/^(\d+)\s*\/\s*(\d+)$/)), (c = b[1] / b[2])), c
            );
          }
          function g(a) {
            var b = parseFloat(a),
            ...
            function d(b) {
              function d(a) {
                ...
                return (
                  T !== a &&
                    (T > a &&
                      ((T = 0), (U = { line: 1, column: 1, seenCR: !1 })),
                    c(U, T, a),
                    (T = a)),
                  U
                );
              ...
              function f(a, e, f) {
                ...
                return (
                  null !== e && g(e),
                  new c(null !== a ? a : h(e, j), e, j, f, i.line, i.column)
                );
              }
              function g() {
                var a, b;
              ...
              var p,
                q = arguments.length > 1 ? arguments[1] : {},
                r = {},
                s = { start: g },
                t = g,
                u = function () {
                ...
                A = function (a, b) {
                  return { url: a, format: b };
                },
                B = function (a) {
                  return { url: a };
                },
                C = "url(",
                D = { type: "literal", value: "url(", description: '"url("' },
                E = ")",
                ...
                M = /^[^)]/,
                N = { type: "class", value: "[^)]", description: "[^)]" },
                O = function (a) {
              ...
              if ("startRule" in q) {
                if (!(q.startRule in s))
                  throw new Error(
                    "Can't start parsing from rule \"" + q.startRule + '".'
                  );
                t = s[q.startRule];
              }
              var Y = a("../util");
              ...
              throw (
                (p !== r &&
                  R < b.length &&
                  e({ type: "end", description: "end of input" }),
                f(null, W, V))
              );
            }
            return b(c, Error), { SyntaxError: c, parse: d };
          })();
        },
        { "../util": 10 },
      ],
      ...
      11: [
        function (a, b, c) {
          ...
          (d.CSSDocumentRule = function () {
            d.CSSRule.call(this),
              (this.matcher = new d.MatcherList()),
              (this.cssRules = []);
          }),
            (d.CSSDocumentRule.prototype = new d.CSSRule()),
            (d.CSSDocumentRule.prototype.constructor = d.CSSDocumentRule),
            (d.CSSDocumentRule.prototype.type = 10),
            Object.defineProperty(d.CSSDocumentRule.prototype, "cssText", {
              get: function () {
      ...
      12: [
        function (a, b, c) {
          ...
          (d.CSSFontFaceRule = function () {
            d.CSSRule.call(this),
              (this.style = new d.CSSStyleDeclaration()),
              (this.style.parentRule = this);
          }),
            (d.CSSFontFaceRule.prototype = new d.CSSRule()),
            (d.CSSFontFaceRule.prototype.constructor = d.CSSFontFaceRule),
            (d.CSSFontFaceRule.prototype.type = 5),
            Object.defineProperty(d.CSSFontFaceRule.prototype, "cssText", {
              get: function () {
        ...
        { "./CSSRule": 17, "./CSSStyleDeclaration": 18 },
      ],
      13: [
        function (a, b, c) {
          var d = {
          ...
          (d.CSSImportRule = function () {
            d.CSSRule.call(this),
              (this.href = ""),
              (this.media = new d.MediaList()),
              (this.styleSheet = new d.CSSStyleSheet());
          }),
            (d.CSSImportRule.prototype = new d.CSSRule()),
            (d.CSSImportRule.prototype.constructor = d.CSSImportRule),
            (d.CSSImportRule.prototype.type = 3),
            Object.defineProperty(d.CSSImportRule.prototype, "cssText", {
              get: function () {
                var a = this.media.mediaText;
                return (
                  "@import url(" + this.href + ")" + (a ? " " + a : "") + ";"
                );
              },
              set: function (a) {
        ...
        { "./CSSRule": 17, "./CSSStyleSheet": 20, "./MediaList": 24 },
      ],
      14: [
        function (a, b, c) {
          var d = {
          ...
          (d.CSSKeyframeRule = function () {
            ...
            (d.CSSKeyframeRule.prototype = new d.CSSRule()),
            (d.CSSKeyframeRule.prototype.constructor = d.CSSKeyframeRule),
            (d.CSSKeyframeRule.prototype.type = 9),
            Object.defineProperty(d.CSSKeyframeRule.prototype, "cssText", {
              get: function () {
      ...
      15: [
        function (a, b, c) {
          var d = { CSSRule: a("./CSSRule").CSSRule };
          (d.CSSKeyframesRule = function () {
            d.CSSRule.call(this), (this.name = ""), (this.cssRules = []);
          }),
            (d.CSSKeyframesRule.prototype = new d.CSSRule()),
            (d.CSSKeyframesRule.prototype.constructor = d.CSSKeyframesRule),
            (d.CSSKeyframesRule.prototype.type = 8),
            Object.defineProperty(d.CSSKeyframesRule.prototype, "cssText", {
              get: function () {
                for (var a = [], b = 0, c = this.cssRules.length; c > b; b++)
                  a.push("  " + this.cssRules[b].cssText);
                return (
      ...
      16: [
        function (a, b, c) {
          ...
          (d.CSSMediaRule = function () {
            ...
            (d.CSSMediaRule.prototype = new d.CSSRule()),
            (d.CSSMediaRule.prototype.constructor = d.CSSMediaRule),
            (d.CSSMediaRule.prototype.type = 4),
            Object.defineProperty(d.CSSMediaRule.prototype, "cssText", {
              get: function () {
                for (var a = [], b = 0, c = this.cssRules.length; c > b; b++)
                  a.push(this.cssRules[b].cssText);
                return (
                  "@media " + this.media.mediaText + " {" + a.join("") + "}"
                );
              },
            }),
            (c.CSSMediaRule = d.CSSMediaRule);
        },
        { "./CSSRule": 17, "./MediaList": 24 },
      ],
      17: [
        function (a, b, c) {
          var d = {};
          (d.CSSRule = function () {
            ...
            (d.CSSRule.STYLE_RULE = 1),
            (d.CSSRule.IMPORT_RULE = 3),
            (d.CSSRule.MEDIA_RULE = 4),
            (d.CSSRule.FONT_FACE_RULE = 5),
            (d.CSSRule.PAGE_RULE = 6),
            (d.CSSRule.WEBKIT_KEYFRAMES_RULE = 8),
            (d.CSSRule.WEBKIT_KEYFRAME_RULE = 9),
            (d.CSSRule.prototype = { constructor: d.CSSRule }),
            (c.CSSRule = d.CSSRule);
        },
        {},
      ],
          ...
          (d.CSSStyleDeclaration = function () {
            ...
            (d.CSSStyleDeclaration.prototype = {
              ...
              removeProperty: function (a) {
                ...
                var c = this[a];
                return (
                  (this[a] = ""), Array.prototype.splice.call(this, b, 1), c
                );
              },
                ...
                for (b = 0; f > b; ++b)
                  (c = e[b]),
                    this.setProperty(
                      ...
                      e.getPropertyPriority(c)
                    );
              },
            }),
            (c.CSSStyleDeclaration = d.CSSStyleDeclaration),
            (d.parse = a("./parse").parse);
        },
        { "./parse": 28 },
      ],
      19: [
        function (a, b, c) {
          ...
          (d.CSSStyleRule = function () {
            ...
            (d.CSSStyleRule.prototype = new d.CSSRule()),
            (d.CSSStyleRule.prototype.constructor = d.CSSStyleRule),
            (d.CSSStyleRule.prototype.type = 1),
            Object.defineProperty(d.CSSStyleRule.prototype, "cssText", {
              get: function () {
                var a;
                return (a = this.selectorText
            ...
            (d.CSSStyleRule.parse = function (a) {
              for (
                var b,
                  ...
                  h = f,
                  i = "",
                  j = { selector: !0, value: !0 },
                  k = new d.CSSStyleRule(),
                  l = "";
                (e = a.charAt(f));
                f++
              )
                switch (e) {
                  ...
                  case "{":
                    "selector" === g &&
                      ((k.selectorText = i.trim()), (i = ""), (g = "name"));
                    break;
                  case ":":
                    "name" === g
                      ? ((c = i.trim()), (i = ""), (g = "value"))
                    ...
                    break;
                  case "!":
                    "value" === g && a.indexOf("!important", f) === f
                      ? ((l = "important"), (f += "important".length))
                      : (i += e);
                    break;
                  case ";":
                    "value" === g
                      ? (k.style.setProperty(c, i.trim(), l),
                        (l = ""),
                        (i = ""),
                        (g = "name"))
                      : (i += e);
      ...
      20: [
        function (a, b, c) {
          ...
          (d.CSSStyleSheet = function () {
            ...
            (d.CSSStyleSheet.prototype = new d.StyleSheet()),
            (d.CSSStyleSheet.prototype.constructor = d.CSSStyleSheet),
            (d.CSSStyleSheet.prototype.insertRule = function (a, b) {
              if (0 > b || b > this.cssRules.length)
                throw new RangeError("INDEX_SIZE_ERR");
              var c = d.parse(a).cssRules[0];
              return (
                (c.parentStyleSheet = this), this.cssRules.splice(b, 0, c), b
              );
            }),
            ...
            (c.CSSStyleSheet = d.CSSStyleSheet),
            (d.parse = a("./parse").parse);
        },
        { "./CSSStyleRule": 19, "./StyleSheet": 25, "./parse": 28 },
      ],
      21: [
        function (a, b, c) {
          var d = {};
          (d.CSSValue = function () {}),
            (d.CSSValue.prototype = {
              constructor: d.CSSValue,
              set cssText(a) {
                var b = this._getConstructorName();
                throw new Exception(
                  'DOMException: property "cssText" of "' + b + '" is readonly!'
                );
              },
              get cssText() {
      ...
      22: [
        function (a, b, c) {
          var d = { CSSValue: a("./CSSValue").CSSValue };
          (d.CSSValueExpression = function (a, b) {
            (this._token = a), (this._idx = b);
          }),
            (d.CSSValueExpression.prototype = new d.CSSValue()),
            (d.CSSValueExpression.prototype.constructor = d.CSSValueExpression),
            (d.CSSValueExpression.prototype.parse = function () {
              for (
                var a,
                  b = this._token,
                  c = this._idx,
                ...
                switch (d) {
                  ...
                  case ")":
                    ...
                    break;
                  case "/":
                    (a = this._parseJSComment(b, c))
                      ? a.error
                        ? (f =
                            "css expression error: unfinished comment in expression!")
                        : (c = a.idx)
                      : (a = this._parseJSRexExp(b, c))
                      ? ((c = a.idx), (e += a.text))
                      : (e += d);
                    break;
                  case "'":
                  case '"':
                    (a = this._parseJSString(b, c, d)),
                      a ? ((c = a.idx), (e += a.text)) : (e += d);
                    break;
                  default:
                    e += d;
                }
              ...
              var h;
              return (h = f ? { error: f } : { idx: c, expression: e });
            }),
            ...
            (d.CSSValueExpression.prototype._parseJSString = function (
              a,
              b,
              c
            ) {
              var d,
                e = this._findMatchedIdx(a, b, c);
              return -1 === e
                ? !1
                : ((d = a.substring(b, e + c.length)), { idx: e, text: d });
            }),
            ...
            (d.CSSValueExpression.prototype._findMatchedIdx = function (
              a,
              b,
              c
            ) {
        ...
        function (a, b, c) {
          ...
          (d.MatcherList = function () {
            ...
            (d.MatcherList.prototype = {
              ...
              set matcherText(a) {
                for (
                  var b = a.split(","), c = (this.length = b.length), d = 0;
                  c > d;
                  d++
                )
                  this[d] = b[d].trim();
              ...
              appendMatcher: function (a) {
                -1 === Array.prototype.indexOf.call(this, a) &&
        ...
        function (a, b, c) {
          ...
          (d.clone = function e(a) {
            ...
            for (
              ...
              if (k) {
                for (
                  var l = (j.style = new d.CSSStyleDeclaration()),
                    m = 0,
                    n = k.length;
                  n > m;
                  m++
              ...
              i.hasOwnProperty("keyText") && (j.keyText = i.keyText),
                i.hasOwnProperty("selectorText") &&
                  (j.selectorText = i.selectorText),
                i.hasOwnProperty("mediaText") && (j.mediaText = i.mediaText),
                i.hasOwnProperty("cssRules") && (j.cssRules = e(i).cssRules);
            }
            return b;
          }),
            (c.clone = d.clone);
      ...
      27: [
        function (a, b, c) {
          "use strict";
          (c.CSSStyleDeclaration = a(
            "./CSSStyleDeclaration"
          ).CSSStyleDeclaration),
            (c.CSSRule = a("./CSSRule").CSSRule),
            (c.CSSStyleRule = a("./CSSStyleRule").CSSStyleRule),
            (c.MediaList = a("./MediaList").MediaList),
            (c.CSSMediaRule = a("./CSSMediaRule").CSSMediaRule),
            (c.CSSImportRule = a("./CSSImportRule").CSSImportRule),
            (c.CSSFontFaceRule = a("./CSSFontFaceRule").CSSFontFaceRule),
            (c.StyleSheet = a("./StyleSheet").StyleSheet),
            (c.CSSStyleSheet = a("./CSSStyleSheet").CSSStyleSheet),
            (c.CSSKeyframesRule = a("./CSSKeyframesRule").CSSKeyframesRule),
            (c.CSSKeyframeRule = a("./CSSKeyframeRule").CSSKeyframeRule),
            (c.MatcherList = a("./MatcherList").MatcherList),
            (c.CSSDocumentRule = a("./CSSDocumentRule").CSSDocumentRule),
            (c.CSSValue = a("./CSSValue").CSSValue),
            (c.CSSValueExpression = a(
              "./CSSValueExpression"
            ).CSSValueExpression),
            (c.parse = a("./parse").parse),
            (c.clone = a("./clone").clone);
        },
        {
          "./CSSDocumentRule": 11,
          "./CSSFontFaceRule": 12,
          ...
          (d.parse = function (a) {
            for (
              ...
              switch (l) {
                ...
                case '"':
                  b = m + 1;
                  do (b = a.indexOf('"', b) + 1), b || u('Unmatched "');
                  while ("\\" === a[b - 2]);
                ...
                case "@":
                  if (a.indexOf("@-moz-document", m) === m) {
                    (n = "documentRule-begin"),
                      (k = new d.CSSDocumentRule()),
                      (k.__starts = m),
                      (m += "-moz-document".length),
                      (o = "");
                    break;
                  }
                  if (a.indexOf("@media", m) === m) {
                    (n = "atBlock"),
                      (g = new d.CSSMediaRule()),
                      (g.__starts = m),
                      (m += "media".length),
                      (o = "");
                    break;
                ...
                case "{":
                  "selector" === n || "atRule" === n
                    ? ((f.selectorText = o.trim()),
                      (f.style.__starts = m),
                      (o = ""),
                      (n = "before-name"))
                    : "atBlock" === n
                    ? ((g.media.mediaText = o.trim()),
                      (r = c = g),
                      (g.parentStyleSheet = q),
                      (o = ""),
                      (n = "before-selector"))
                    : "fontFaceRule-begin" === n
                    ? (c && (i.parentRule = c),
                      (i.parentStyleSheet = q),
                      (f = i),
                      (o = ""),
                      (n = "before-name"))
                    : "keyframesRule-begin" === n
                    ? ((j.name = o.trim()),
                      c && (j.parentRule = c),
                      (j.parentStyleSheet = q),
                      (r = c = j),
                      (o = ""),
                      (n = "keyframeRule-begin"))
                    : "keyframeRule-begin" === n
                    ? ((f = new d.CSSKeyframeRule()),
                      (f.keyText = o.trim()),
                      (f.__starts = m),
                      (o = ""),
                      (n = "before-name"))
                    : "documentRule-begin" === n &&
                      ((k.matcher.matcherText = o.trim()),
                      c && (k.parentRule = c),
                      (r = c = k),
                      (k.parentStyleSheet = q),
                      (o = ""),
                      (n = "before-selector"));
                  break;
                case ":":
                  "name" === n
                    ? ((e = o.trim()), (o = ""), (n = "before-value"))
                    : (o += l);
                  break;
                case "(":
                  if ("value" === n)
                  ...
                  break;
                case "!":
                  "value" === n && a.indexOf("!important", m) === m
                    ? ((s = "important"), (m += "important".length))
                    : (o += l);
                  break;
                case ";":
                  switch (n) {
                    case "value":
                      f.style.setProperty(e, o.trim(), s),
                        (s = ""),
                        (o = ""),
                        (n = "before-name");
                      break;
                    case "atRule":
                      ...
                      break;
                    case "importRule":
                      (h = new d.CSSImportRule()),
                        (h.parentStyleSheet = h.styleSheet.parentStyleSheet =
                          q),
                        (h.cssText = o + l),
                        q.cssRules.push(h),
                        (o = ""),
                ...
                case "}":
                  switch (n) {
                    ...
                    case "name":
                      (f.__ends = m + 1),
                        c && (f.parentRule = c),
                        (f.parentStyleSheet = q),
                        r.cssRules.push(f),
                        (o = ""),
                        (n =
                          r.constructor === d.CSSKeyframesRule
                            ? "keyframeRule-begin"
                            : "before-selector");
                      break;
            ...
            (c.parse = d.parse),
            (d.CSSStyleSheet = a("./CSSStyleSheet").CSSStyleSheet),
            (d.CSSStyleRule = a("./CSSStyleRule").CSSStyleRule),
            (d.CSSImportRule = a("./CSSImportRule").CSSImportRule),
            (d.CSSMediaRule = a("./CSSMediaRule").CSSMediaRule),
            (d.CSSFontFaceRule = a("./CSSFontFaceRule").CSSFontFaceRule),
            (d.CSSStyleDeclaration = a(
              "./CSSStyleDeclaration"
            ).CSSStyleDeclaration),
            (d.CSSKeyframeRule = a("./CSSKeyframeRule").CSSKeyframeRule),
            (d.CSSKeyframesRule = a("./CSSKeyframesRule").CSSKeyframesRule),
            (d.CSSValueExpression = a(
              "./CSSValueExpression"
            ).CSSValueExpression),
          ...
          var f = function (a) {
            ...
            g = function (a) {
              ...
              for (b = 0; b < a.length; b++)
                try {
                  return (d = c.extractCssUrl(a[b])), { url: d, idx: b };
                } catch (e) {}
            };
          (c.parse = function (a) {
            var b = f(a);
            ...
            (c.serialize = function (a) {
              var b = a.map(function (a) {
                ...
                return (
                  a.url && b.push('url("' + a.url + '")'),
                  a.postUrl && (b = b.concat(a.postUrl)),
                  b.join(" ")
                );
              });
              return b.join(", ");
          ...
          (c.rulesForCssText = function (a) {
            ...
            (c.changeFontFaceRuleSrc = function (a, b, d) {
              var e =
                ...
                b.style.getPropertyValue("font-family") +
                "; ";
              b.style.getPropertyValue("font-style") &&
                (e +=
                  "font-style: " +
                  b.style.getPropertyValue("font-style") +
                  "; "),
                b.style.getPropertyValue("font-weight") &&
                  (e +=
                    "font-weight: " +
                    b.style.getPropertyValue("font-weight") +
                    "; "),
                (e += "src: " + d + "}"),
                c.exchangeRule(a, b, e);
            });
        },
        { cssom: 27 },
      ],
      31: [
        function (a, b, c) {
          ...
          var d = a("./util"),
            ...
            j = function (a) {
              var b = a.map(function (b, c) {
                return (
                  c === a.length - 1 && (b = { baseUrl: i(b.baseUrl) }),
                  JSON.stringify(b)
                );
              });
              return b;
            ...
            k = function (a, b) {
              return b.cache !== !1 && "none" !== b.cache && b.cacheBucket
                ? d.memoize(a, j, b.cacheBucket)
                : a;
            },
            l = function (a, b, c) {
              ...
              return g.loadCSSImportsForRules(d, b, c).then(function (b) {
                return g
                  .loadAndInlineCSSResourcesForRules(d, c)
                  .then(function (c) {
                    var e = b.errors.concat(c.errors),
                      f = b.hasChanges || c.hasChanges;
                    return (
                      f && (a = h.cssRulesToText(d)),
                      { hasChanges: f, content: a, errors: e }
                    );
                  });
              });
            },
            m = function (a, b, c) {
              ...
              return f(e, c, b).then(function (b) {
                return (
                  b.hasChanges && (a.childNodes[0].nodeValue = b.content),
                  d.cloneArray(b.errors)
                );
              });
            },
            n = function (a) {
              ...
              return Array.prototype.filter.call(b, function (a) {
                return (
                  !a.attributes.type ||
                  "text/css" === a.attributes.type.nodeValue
                );
              });
            };
          c.loadAndInlineStyles = function (a, b) {
            ...
            return (
              (c = d.clone(b)),
              (c.baseUrl = c.baseUrl || d.getDocumentBaseUrl(a)),
              d
                .all(
                  e.map(function (a) {
          ...
          var o = function (a, b) {
              ...
              (b = b.trim()),
                b &&
                  ((c = a.ownerDocument.createElement("style")),
                  (c.type = "text/css"),
                  c.appendChild(a.ownerDocument.createTextNode(b)),
                  d.insertBefore(c, a)),
                d.removeChild(a);
            },
            p = function (a, b) {
              return d
                ...
                .then(function (a) {
                  return g
                    .loadCSSImportsForRules(a.cssRules, [], b)
                    .then(function (b) {
                      return {
                        content: a.content,
                        cssRules: a.cssRules,
                ...
                .then(function (a) {
                  return g
                    .loadAndInlineCSSResourcesForRules(a.cssRules, b)
                    .then(function (b) {
                      return {
                        content: a.content,
                        cssRules: a.cssRules,
                ...
                .then(function (a) {
                  var b = a.content;
                  return (
                    a.hasChanges && (b = h.cssRulesToText(a.cssRules)),
                    { content: b, errors: a.errors }
                  );
                });
            },
            q = function (a, b) {
              ...
              return g(c, f).then(function (a) {
                return { content: a.content, errors: d.cloneArray(a.errors) };
              });
            },
            r = function (a) {
              ...
              return Array.prototype.filter.call(b, function (a) {
                return (
                  a.attributes.rel &&
                  "stylesheet" === a.attributes.rel.nodeValue &&
                  (!a.attributes.type ||
                    "text/css" === a.attributes.type.nodeValue)
                );
              });
          ...
          (c.loadAndInlineCssLinks = function (a, b) {
            ...
            (c.loadAndInlineImages = e.inline),
            (c.loadAndInlineScript = f.inline),
            (c.inlineReferences = function (a, b) {
              var e = [],
                f = [
                  c.loadAndInlineImages,
                  c.loadAndInlineStyles,
                  c.loadAndInlineCssLinks,
                ];
              return (
                b.inlineScripts !== !1 && f.push(c.loadAndInlineScript),
                d
                  .all(
                    f.map(function (c) {
          ...
          var d = a("ayepromise"),
            ...
            j = function (a) {
              return a.filter(function (a) {
                return (
                  a.type === window.CSSRule.STYLE_RULE &&
                  (a.style.getPropertyValue("background-image") ||
                    a.style.getPropertyValue("background"))
                );
              });
            },
            k = function (a) {
            ...
            l = function (a) {
              return a.filter(function (a) {
                return (
                  a.type === window.CSSRule.FONT_FACE_RULE &&
            ...
            return (
              d.forEach(function (b) {
                ...
                f.length > 0 &&
                  ...
                  (c = g.serialize(d)),
                  i(b.rule, b.property, c),
                  (p = !0));
              }),
              l(b).forEach(function (c) {
                var d,
                  g,
                  i = c.style.getPropertyValue("src");
                try {
                  d = h.parse(i);
                } catch (j) {
                  return;
                ...
                (g = o(d)),
                  g.length > 0 &&
                    ...
                    f.changeFontFaceRuleSrc(b, c, h.serialize(d)),
                    (p = !0));
              }),
                  ...
                  : (d.push(h),
                    e.ajax(i, g).then(
                      function (e) {
                        ...
                        return c
                          .loadCSSImportsForRules(h, d, g)
                          .then(function (d) {
                            return (
                              c.adjustPathsOfCssResources(i, h),
                              p(a, b, h),
                              d.errors
                            );
                          });
          ...
          var s = function (a, b) {
              ...
              return e
                .collectAndReportErrors(
                  d.map(function (a) {
                    var d = c[a].url;
                    return e.getDataURIForImageURL(d, b).then(
                      function (b) {
                        (c[a].url = b), (f = !0);
                      },
                      function (a) {
                ...
                .all(
                  d.map(function (a) {
                    return s(a.value, b).then(function (b) {
                      b.hasChanges &&
                        (i(a.rule, a.property, b.backgroundValue), (g = !0)),
                        (f = f.concat(b.errors));
                    });
                  })
                )
                ...
                e
                  .collectAndReportErrors(
                    d.map(function (a) {
                      var d = c[a],
                        g = d.format || "woff";
                      return e.binaryAjax(d.url, b).then(
                        function (a) {
                          var b = btoa(a);
                ...
                .all(
                  c.map(function (c) {
                    ...
                    return u(e, b).then(function (b) {
                      b.hasChanges &&
                        (f.changeFontFaceRuleSrc(a, c, b.srcDeclarationValue),
                        (g = !0)),
                        (d = d.concat(b.errors));
                    });
                  })
        ...
        function (a, b, c) {
          ...
          var d = a("./util"),
            e = function (a, b) {
              ...
              return (
                !f.baseUrl && e && (f.baseUrl = e),
                d.getDataURIForImageURL(c, f).then(
                  function (a) {
                    return a;
                  },
                  function (a) {
          ...
          c.inline = function (a, b) {
            var c = h(a.getElementsByTagName("img")),
              ...
              j = f(c.concat(i));
            return d.collectAndReportErrors(
              j.map(function (a) {
      ...
      35: [
        function (a, b, c) {
          ...
          var f = null,
            g = function (a, b) {
              return b === !1 || "none" === b || "repeated" === b
                ? ((null === f || "repeated" !== b) && (f = Date.now()),
                  a + "?_=" + f)
                : a;
            };
          (c.ajax = function (a, b) {
            var d,
              ...
              j = function () {
                h.reject({ msg: "Unable to load url", url: i });
              };
            (d = g(i, b.cache)),
              f.addEventListener(
                "load",
                function () {
                  200 === f.status || 0 === f.status
                    ? h.resolve(f.response)
                    : j();
                },
                !1
              ),
              f.addEventListener("error", j, !1);
            try {
              f.open("GET", d, !0),
            ...
            (c.binaryAjax = function (a, b) {
              var d = c.clone(b);
              return (
                (d.mimeType = "text/plain; charset=x-user-defined"),
                c.ajax(a, d).then(function (a) {
      ...
      36: [
        function (a, b, c) {
          ...
          var d = function (a) {
            ...
            e = function (a) {
              return "parsererror" === a.documentElement.tagName &&
                "http://www.mozilla.org/newlayout/xml/parsererror.xml" ===
                  a.documentElement.namespaceURI
                ? a.documentElement
                : ("xml" === a.documentElement.tagName ||
                    "html" === a.documentElement.tagName) &&
                  a.documentElement.childNodes &&
                  a.documentElement.childNodes.length > 0 &&
                  "parsererror" === a.documentElement.childNodes[0].nodeName
                ? a.documentElement.childNodes[0]
                : "html" === a.documentElement.tagName &&
                  a.documentElement.childNodes &&
                  a.documentElement.childNodes.length > 0 &&
                  "body" === a.documentElement.childNodes[0].nodeName &&
                  a.documentElement.childNodes[0].childNodes &&
                  a.documentElement.childNodes[0].childNodes.length &&
                  "parsererror" ===
                    a.documentElement.childNodes[0].childNodes[0].nodeName
                ? a.documentElement.childNodes[0].childNodes[0]
                : void 0;
            },
            f = [
              new RegExp(
            ...
            h = function (a) {
              ...
              var c = e(a);
              if (void 0 !== c)
                throw ((b = g(c) || "Parse error"), new Error(b));
            };
              ...
              if (
                (p &&
                  ...
                  a.protocol &&
                    ...
                    (a.port = null),
                    a.host &&
                      ("" === e[0] ? (e[0] = a.host) : e.unshift(a.host)),
                    (a.host = null)),
                  (m = m && ("" === e[0] || "" === o[0]))),
                j)
              )
                ...
                if (p) {
                  ...
                  q &&
                    ((c.auth = q.shift()), (c.host = c.hostname = q.shift()));
                }
                return (
                  (c.search = a.search),
                  (c.query = a.query),
        ...
        function (a, b, c) {
          var d = function (a) {
            ...
            i = function (a) {
              var b =
                Array.prototype.map
                  .call(a.attributes || a.attrs, function (a) {
                    return a.name;
                  })
                  .indexOf("xmlns") >= 0;
              return b ||
                (a.parentNode &&
                  a.namespaceURI === a.parentNode.namespaceURI &&
                  "html" !== h(a))
                ? ""
